...
public class ElbertSkill extends JavaPlugin implements Listener {
     ...
     */
    public boolean hasTagItem(PlayerInventory inventory, String tag) {
     ...
     * @return true:携带 false:不携带
     */
    public boolean hasTagItem(ItemStack itemStack, String tag) {
     ...
     */
    public void makePlunderItem(ItemStack itemStack, String tag) {
        if (hasTagItem(itemStack, tag))
            return;
        ItemMeta itemMeta = itemStack.getItemMeta();
        if (itemMeta == null)
     ...
     */
    public int readItemNumericProperties(ItemStack itemStack, String tag) {
     ...
     */
    public void writeItemNumericProperties(ItemStack itemStack, String tag, int num) {
        var itemMeta = itemStack.getItemMeta();
